...
public class ScheduleEntityService(IScheduleEntityRepository scheduleEntityRepository) : IScheduleEntityService
{
    ...
    /// </summary>
    public Task UpdateLastEntityCreated(Guid id, DateOnly entityCreated, CancellationToken cancellationToken = default)
    {
        return scheduleEntityRepository.GetAndUpdateAndSaveAsync(id, scheduleEntity =>
        {
