...
public class DbContextBase<TContext> : DbContext where TContext : DbContext
{
    ...
    internal static T AddEntity<T>(DbSet<T> entityCollection, T entity) where T : class, IDbEntity
    {
    ...
    internal static void AddEntities<T>(DbSet<T> entityCollection, IEnumerable<T> entities) where T : class, IDbEntity
    {
    ...
    internal static void UpdateEntities<T>(DbSet<T> entityCollection, IEnumerable<T> entities) where T : class, IDbEntity
    {
