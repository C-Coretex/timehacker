...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
    {
        var filteredMembers = FilterNavigationProperties<TType>(instance, context, members);
    ...
    public static ICollection<MemberInfo> FilterNavigationProperties<TType>(object instance, AutoGenerateContext context, IEnumerable<MemberInfo> members)
    {
